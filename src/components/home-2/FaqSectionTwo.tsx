...
import thumbImg from "../../../public/assets/img/about/faq-thumb.png";
import thumbImgTwo from "../../../public/assets/img/logo/gm-thumb.png";
import Image from 'next/image';
interface TFaqProps {
    faq_area?:string
}
const FaqSectionTwo = ({faq_area}:TFaqProps) => {
    return (
            ...
            <div className="row wow fadeInUp" data-wow-delay=".3s">
               <div className="col-lg-6">
                  <div className="faq-img mb-60">
                     <Image style={{width:"100%", height:"auto"}} src={thumbImg} alt="thumb-img"/>
                     <div className="faq-thumb">
                     <Image style={{width:"100%", height:"auto"}} src={thumbImgTwo} alt="thumb-img"/>
                     </div>
                  </div>
               </div>
               <div className="col-lg-6">
