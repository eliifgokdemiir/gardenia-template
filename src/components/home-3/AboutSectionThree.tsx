...
import aboutServiceImg from '../../../public/assets/img/bg/about-service-bg.png';
import serviceTabImg from '../../../public/assets/img/service/service-tab-img.png';
import serviceTabTwo from '../../../public/assets/img/service/service-tab2-img.png';
                    ...
                    <div className="about-tab-content wow fadeInUp" data-wow-delay=".3s">
                        <div className="tab-content" id="nav-tabContent">
                            <div className="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab">
                                <div className="about-service-wrapper">
                                    <div className="about-service-bg">
                                        <Image style={{width:"auto", height:"auto"}} src={aboutServiceImg} alt="about-img" />
                                    </div>
                                    <div className="row gx-0 align-items-center">
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            <Image style={{width:"100%", height:"auto"}} src={serviceTabImg} alt="tab-img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="tab-pane fade" id="nav-2" role="tabpanel" aria-labelledby="nav-2-tab">
                                <div className="about-service-wrapper">
                                    <div className="about-service-bg">
                                    <Image style={{width:"100%", height:"auto"}} src={aboutServiceImg} alt="about-img" />
                                    </div>
                                    <div className="row gx-0 align-items-center">
                                        <div className="col-lg-6">
                                            <div className="service-tab-content">
                                        ...
                                        <div className="col-lg-6">
                                            <div className="service-tab-img">
                                            <Image style={{width:"100%", height:"auto"}} src={serviceTabTwo} alt="tab-img" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
